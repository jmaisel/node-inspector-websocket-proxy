    ...
    this.$rules = {
        "no_regex": [
            ...
            functionCallStartRule,
            {
                ...
                regex: /(console)(\.)(warn|info|log|error|debug|time|traceWire|timeEnd|assert)\b/
            }, {
                token: keywordMapper,
                regex: identifierRe
            }, {
...
var RubyHighlightRules = function () {
    var builtinFunctions = ("abort|Array|assert|assert_equal|assert_not_equal|assert_same|assert_not_same|" +
        ...
        "raw|readline|readlines|redirect?|request_via_redirect|require|scanTargets|select|" +
