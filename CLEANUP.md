...
**Priority Quick Wins:**
- [ ] Add `.eslintrc.json`
- [ ] Fix synchronous AJAX in `project-helper.js:207`
- [ ] Add WebSocket cleanup in `gpio-websocket-client.js`
- [ ] Extract constants to `www/app/constants.js`
- [ ] Add try/catch around all JSON.parse operations
...
1. **Split god files:**
   - `project-helper.js` (1,018 lines) → `ProjectAPI`, `ProjectUI`, `ProjectState`
   - `main.js` (688 lines) → `AppBootstrap`, `ModeController`, `CircuitController`
