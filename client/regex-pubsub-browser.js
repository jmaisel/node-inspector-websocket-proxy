/**
 * RegexPubSub - A publish/subscribe queue with regex pattern matching (Browser Version)
 *
...
class RegexPubSub {
  ...
  publish(topic, data) {
    ...
    console.log(`publishing to ${topic} using data`, data);
...
// Export for browser (if using modules) or make it globally available
if (typeof module !== 'undefined' && module.exports) {
  module.exports = RegexPubSub;
} else if (typeof window !== 'undefined') {
  window.RegexPubSub = RegexPubSub;
}